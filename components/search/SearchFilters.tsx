      ...
      <div className="mb-6 space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            ...
            <button
              type="submit"
              className="px-2.5 py-1.5 text-[11px] font-medium rounded-md bg-[var(--ink)] text-white"
            >
              {lang === "ja" ? "絞込" : "Filter"}
            </button>
          </form>
...
function Chip({ label, onRemove }: { label: string; onRemove: () => void }) {
  return (
    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 text-[11px] font-medium rounded-full bg-[var(--ink)] text-white">
      {label}
